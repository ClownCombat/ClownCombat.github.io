<template>
  <div id="devInfoContainer">
    ...
    <CodingLanguageInfo info="JavaScript / TypeScript" years=9 />
...
import CodingLanguagesHeadline from "./CodingLanguageHeadline.vue";
import CodingLanguageInfo from "./CodingLanguageInfo.vue";
</script>
